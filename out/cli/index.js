...
const class_language_module_1 = require("../language-server/class-language-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const node_1 = require("langium/node");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, class_language_module_1.createClassLanguageServices)(node_1.NodeFileSystem).ClassLanguage;
...
function default_1() {
    ...
    const fileExtensions = module_1.ClassLanguageLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
